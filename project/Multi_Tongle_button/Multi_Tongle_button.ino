...
#define FIREBASE_HOST "medical-bot-6cfa2-default-rtdb.firebaseio.com" // change here
#define FIREBASE_AUTH "M1vkG6QyXyAOUUOcBchhQpuZOv4HjwQdfMTTA1ne"// change here
...
void loop ()
{
  ...
  if(Firebase.getString(firebaseData, "test/Led4Status")){
